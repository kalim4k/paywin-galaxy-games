      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="space-y-2">
          {!uploadMethod && <div className="flex flex-col space-y-2">
              <Button onClick={() => setUploadMethod('file')} variant="outline" size="sm" className="border-gray-300 bg-gray-50 text-gray-950">
          ...
          {currentAvatarUrl && <Button onClick={handleRemoveImage} variant="outline" size="sm" className="border-red-300 text-red-600 bg-fuchsia-200 hover:bg-fuchsia-100">
